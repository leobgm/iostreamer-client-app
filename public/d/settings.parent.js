...
(function () {
    ...
    parent_settings.add_control(new TextInput(parent_settings, {
        "name": "parent_password",
        "label": word['parent_settings_old_pass'],
        "type": "password"
    }));
    parent_settings.add_control(new TextInput(parent_settings, {
        "name": "pass",
        "label": word['parent_settings_new_pass'],
        "type": "password"
    }));
    parent_settings.add_control(new TextInput(parent_settings, {
        "name": "repeat_pass",
        "label": word['parent_settings_repeat_new_pass'],
        "type": "password"
    }));
