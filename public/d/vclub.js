...
(function () {
    ...
    var sort_menu = [
        ...
        {
            "label": word['vclub_only_hd'], "cmd": function () {
                this.parent.load_params.sortby = 'added';
                this.parent.load_params.fav = false;
        ...
        {
            "label": word['vclub_not_ended'], "cmd": function () {
    ...
    if (stb.profile['kinopoisk_rating']) {
        ...
        var rating_item = {
            "label": get_word('vclub_by_rating'), "cmd": function () {
                this.parent.load_params.fav = false;
    ...
    if (stb.profile['show_purchased_filter']) {
        var purchased_item = {
            "label": get_word('vclub_only_purchased'), "cmd": function () {
                this.parent.load_params.fav = false;
