...
function common_xpcom(){
    ...
    this.user_init = function(user_data){
        ...
        if (['MAG200', 'MAG256', 'MAG257', 'MAG260', 'MAG322', 'MAG323', 'MAG324', 'MAG325', 'MAG349', 'MAG350', 'MAG351', 'MAG352','MAG424','MAG520','MAG524'].indexOf(this.type) === -1  && !_GET['debug_key']){
        ...
        if (this.user['status'] == 2){
            ...
            try{
                ...
                if (['MAG200', 'MAG245','MAG245D', 'MAG250', 'MAG254', 'MAG255', 'MAG256', 'MAG257', 'MAG270', 'MAG275', 'MAG322', 'MAG323', 'MAG324', 'MAG325', 'MAG349', 'MAG350', 'MAG351', 'MAG352', 'WR320','MAG424', 'IP_STB_HD'].indexOf(this.type) >= 0 || this.type.indexOf('AuraHD') != -1){
                    this.check_image_version();
                }
